...
@dso_cache = dso_local local_unnamed_addr global [474 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 307049987, ; hash 0x124d3603, from name: libaot-AhorcdoTEAM1
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 325941946, ; hash 0x136d7aba, from name: aot-AhorcdoTEAM1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AhorcdoTEAM1.dll.so
		ptr null; void* handle (0x0)
	}, ; 32
	...
	%struct.DSOCacheEntry {
		i64 1142407664, ; hash 0x4417c1f0, from name: aot-AhorcdoTEAM1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AhorcdoTEAM1.dll.so
		ptr null; void* handle (0x0)
	}, ; 118
	...
	%struct.DSOCacheEntry {
		i64 1636352814, ; hash 0x6188c32e, from name: AhorcdoTEAM1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AhorcdoTEAM1.dll.so
		ptr null; void* handle (0x0)
	}, ; 168
	...
	%struct.DSOCacheEntry {
		i64 1978794405, ; hash 0x75f201a5, from name: libaot-AhorcdoTEAM1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AhorcdoTEAM1.dll.so
		ptr null; void* handle (0x0)
	}, ; 214
	...
	%struct.DSOCacheEntry {
		i64 4009672216, ; hash 0xeefebe18, from name: AhorcdoTEAM1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AhorcdoTEAM1.dll.so
		ptr null; void* handle (0x0)
	}, ; 444
