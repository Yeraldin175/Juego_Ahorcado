...
@dso_cache = dso_local local_unnamed_addr global [474 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 4510522624883592894, ; hash 0x3e98986df78c8ebe, from name: libaot-AhorcdoTEAM1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AhorcdoTEAM1.dll.so
		ptr null; void* handle (0x0)
	}, ; 112
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 5234884242800328739, ; hash 0x48a60b7bb4674023, from name: AhorcdoTEAM1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AhorcdoTEAM1.dll.so
		ptr null; void* handle (0x0)
	}, ; 123
	...
	%struct.DSOCacheEntry {
		i64 7059770792513951864, ; hash 0x61f95821ab78d878, from name: aot-AhorcdoTEAM1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AhorcdoTEAM1.dll.so
		ptr null; void* handle (0x0)
	}, ; 160
	...
	%struct.DSOCacheEntry {
		i64 10767811154846501425, ; hash 0x956ef331ed1d4a31, from name: AhorcdoTEAM1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AhorcdoTEAM1.dll.so
		ptr null; void* handle (0x0)
	}, ; 265
	...
	%struct.DSOCacheEntry {
		i64 11840223755371845557, ; hash 0xa450ecc5f81497b5, from name: libaot-AhorcdoTEAM1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AhorcdoTEAM1.dll.so
		ptr null; void* handle (0x0)
	}, ; 300
	...
	%struct.DSOCacheEntry {
		i64 15107091292266209173, ; hash 0xd1a72b7d50ec9f95, from name: aot-AhorcdoTEAM1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AhorcdoTEAM1.dll.so
		ptr null; void* handle (0x0)
	}, ; 389
...
@.env.3 = private unnamed_addr constant [37 x i8] c"3240a49a-9f48-4208-beaa-08cc24c2d1ca\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [29 x i8] c"com.companyname.ahorcdoteam1\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [27 x i8] c"libaot-AhorcdoTEAM1.dll.so\00", align 16
